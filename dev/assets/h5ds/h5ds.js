...
//事件 ....
import './otherEvent/toggleLeftBox.js'; //点击右侧(模板中心的显示和隐藏)
import './otherEvent/setApp.js'; //设置app参数(基本设置,背景音乐,加载效果,帮助说明)
import './otherEvent/source.js'; //资源库事件 //(我的图库和系统图库和替换图片)
...
import { sysTpls, myTpls } from './source/tplSource.js'; // 模板资源(模板中心,我的模板)
